...
class ParaphraseGPT(nn.Module):
  ...
  def __init__(self, args):
    super().__init__()
    self.gpt = GPT2Model.from_pretrained(model=args.model_size, d=args.d, l=args.l, num_heads=args.num_heads, recurrency=args.recurrency)
...
def train(args):
  ...
  args.run="GPT Full Finetune + Recurrency + One step GD"
